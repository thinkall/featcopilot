...
def generate_report(results: list[dict]) -> str:
    ...
    report.append("\n## Datasets\n")
    report.append("### Kaggle-style Datasets")
    report.append("- Titanic - Survival classification")
    report.append("- House Prices - Price regression")
    report.append("- Credit Card Fraud - Imbalanced classification")
    report.append("- Bike Sharing - Demand regression")
    ...
    report.append("- Complex Classification - Multi-class classification")
    report.append("\n### Time Series Datasets")
    report.append("- Sensor Efficiency - Industrial IoT regression")
    report.append("- Retail Demand - Demand forecasting regression")
    report.append("- Server Latency - Performance prediction regression")
    report.append("\n### Text/Semantic Datasets")
    report.append("- Product Reviews - Sentiment classification")
    report.append("- News Headlines - Category classification")
    report.append("- Customer Support Tickets - Priority classification")
    report.append("- Medical Notes - Diagnosis classification")
    report.append("- Job Postings - Salary regression")
    report.append("- E-commerce Products - Rating regression")
